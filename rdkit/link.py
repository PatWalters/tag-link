...
def map_attached_atom(mol, atomic_num, map_idx):
    """
...
def link_molecules(in_mol_1, atm_type_1, in_mol_2, atm_type_2):
    """
    Link two molecules with a single bond
    E.g. [Au]CCC + [Au]c1ccccc1 -> CCC-c1ccccc1
    :param in_mol_1: the first molecule
    :param atm_type_1: the atom type of the link atom in the first molecule
    :param in_mol_2: the second molecule
    :param atm_type_2: the atom type of the link atom in the second molecule
    :return: modified molecule
    """
    mol_1 = map_attached_atom(in_mol_1, atm_type_1, 1)
    mol_2 = map_attached_atom(in_mol_2, atm_type_2, 2)
